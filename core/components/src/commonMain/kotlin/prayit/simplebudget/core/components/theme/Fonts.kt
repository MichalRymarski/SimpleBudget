...
fun cormorantGaramondBold(): FontResource = Res.font.CormorantGaramond_Bold

fun cormorantGaramondRegular(): FontResource = Res.font.CormorantGaramond_Regular

fun cormorantGaramondSemiBold(): FontResource = Res.font.CormorantGaramond_SemiBold

fun robotoFlex(): FontResource = Res.font.RobotoFlex
